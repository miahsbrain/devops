#!/bin/bash
# =============================================================================
# Deploy: Service 2 — Orders API (GKE)
...
export SERVICE_NAME="service-2-orders-api"
...
kubectl set image deployment/service-2-orders-api-deployment \
    service-2-orders-api="${IMAGE_PATH}"

# =============================================================================
# STEP 6: Wait for rollout
# =============================================================================
info "Waiting for rollout to complete..."
kubectl rollout status deployment/service-2-orders-api-deployment --timeout=120s

success "Service 2 (Orders API) deployed successfully."
echo ""
echo "  Image : ${IMAGE_PATH}"
echo "  Internal DNS (for GKE pods)     : http://service-2-orders-api.k8s.api.internal"
echo "  Public path (via Nginx ingress) : http://NGINX_PUBLIC_IP.nip.io/api/orders"
