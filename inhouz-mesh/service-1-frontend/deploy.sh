...
export SERVICE_NAME="service-1-frontend"
export IMAGE_TAG="${1:-latest}" # Pass a tag as arg, defaults to latest
...
# =============================================================================
# STEP 5: Update the image tag in the deployment and apply manifests
# =============================================================================
info "Applying Kubernetes deployment manifests..."
# Update the image in the manifest to use the exact tag we just pushed
kubectl apply -f k8s-deployment.yaml

# Force a rollout with the new image tag
kubectl set image deployment/service-1-frontend-deployment \
    service-1-frontend="${IMAGE_PATH}"

# =============================================================================
# STEP 6: Wait for rollout to complete
# =============================================================================
info "Waiting for rollout to complete..."
kubectl rollout status deployment/service-1-frontend-deployment --timeout=120s

success "Service 1 (Frontend) deployed successfully."
echo ""
echo "  Image : ${IMAGE_PATH}"
echo "  Accessible via public Nginx ingress at: http://NGINX_PUBLIC_IP.nip.io/"
